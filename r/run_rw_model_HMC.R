...
fname_model = 'ring_model_t_date_size_pdbh_avg_HMC'
source(paste0('models/', fname_model, '.R'))
...
#######################################################################################################################################
fname_model = 'ring_model_t_date_size_pdbh_HMC_NOCOVAR'
load(paste0('data/dump/', fname_data, '.rdata'))
source(paste0('models/', fname_model, '.R'))
...
# full model but with zero covariance; not efficient
#######################################################################################################################################
fname_model = 'ring_model_t_size_pdbh_HMC_NOCOVAR'
load(paste0('data/dump/', fname_data, '.rdata'))
source(paste0('models/', fname_model, '.R'))
...
# full model but with zero covariance; not efficient
#######################################################################################################################################
fname_model = 'ring_model_t_pdbh_HMC_NOCOVAR'
load(paste0('data/dump/', fname_data, '.rdata'))
source(paste0('models/', fname_model, '.R'))
...
save(out, file = paste0('output/', fname_model, '_', mvers, '.Rdata'))
#########################################################################################################################################
## run without census data with zero covariance
#########################################################################################################################################
fname_model = 'ring_model_t_pdbh_HMC_NOCOVAR'
...
fname_model = 'ring_model_t_pdbh_nc_HMC_NOCOVAR_sigd'
