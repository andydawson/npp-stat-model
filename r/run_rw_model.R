...
# load('data/dump/tree_full.rdata')
load(paste0('data/dump/tree_data_20_', dvers, '.rdata'))
...
fname_model = 'ring_model_t_date_sapl_size_pdbh_avg'
...
m$setData(list(logDobs = logDobs, logXobs = logXobs_a, sapling_constraint = rep(1, N_saplings)))#, tau2_constraint=c(1), tau3_constraint=c(1)))#not_cens = rep(1, N_saplings)))#s
...
# }
# 
# if ((fname_model == 'ring_model_t_date_sapl_size_pdbh_avg')|(fname_model == 'ring_model_t_date_sapl_size_constraint')) {
#   inits = c(inits, list(beta_slope=0.1))
# }
...
#######################################################################################################################################
# no census data and with zero covariance; not efficient
#######################################################################################################################################
fname_model = 'ring_model_t_date_sapl_size_pdbh_NOCOVAR'
load(paste0('output/', fname_model, '_', mvers, '.Rdata'))
